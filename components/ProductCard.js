            ...
            <View className="mt-5">
                <View className="flex-row justify-between">
                    ...
                    <View className="flex-row items-center">
                        ...
                        />
                        <Text className="pl-1 text-xs font-light text-gray-400">
                            {moment(new Date(lastChecked)).fromNow()}
                        </Text>
                    </View>
                </View>
                <Text
                    numberOfLines={2}
                    className="text-slate-50 pt-1 text-lg font-semibold leading-5"
                >
                    {title}
                </Text>
                <View className="flex-row self-center justify-between pt-3 divide-x divide-gray-200">
                    <View className="items-center px-3 w-1/2">
                        ...
                        <View className="flex-row">
                            <Text className="text-slate-50 text-xs font-semibold leading-4">
                                EGP
                            </Text>
                            <Text className="text-slate-50 font-bold text-3xl">
                                {formatNumber(price)}
                            </Text>
                        </View>
                    </View>
                ...
                {availability ? (
                    <TouchableOpacity
                        onPress={() => openUrl(url)}
                        className="bg-light-black flex-row justify-center w-full rounded-sm self-center mt-5 p-3"
                    >
                    ...
                    <TouchableOpacity
                        onPress={() => openUrl(url)}
                        className="bg-light-red flex-row justify-center w-full rounded-sm self-center mt-5 p-3"
                    >
